...
import { Users, TrendingUp, Brain, MessageSquare, LayoutDashboard, LogOut, Shield } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b">
          <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center shadow">
